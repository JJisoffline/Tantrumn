...
void ATantrumnCharacterBase::RequestCrouchStart()
{

}

void ATantrumnCharacterBase::RequestCrouchEnd()
{
...
void ATantrumnCharacterBase::OnStunBegin(float StunRatio)
{
	...
	//Todo play montage, listen to montage end, disable player movement
}

void ATantrumnCharacterBase::OnStunEnd()
{
	//stop montage, unbind from montage end, enable player movement
}
